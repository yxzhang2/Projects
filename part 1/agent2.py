...
class Agent:
    ...
    def act(self, state, points, dead):
        ...
        #Modified state config
        food_diagonal=0

        for i in range (18):
            if (food_x*i==snake_head_x and food_y*i==snake_head_y):
                food_diagonal=1
            elif ((food_x*i==-snake_head_x and food_y*i==snake_head_y)):
                food_diagonal=2
            elif ((food_x*i==snake_head_x and food_y*i==-snake_head_y)):
                food_diagonal=2
            elif ((food_x*i==-snake_head_x and food_y*i==-snake_head_y)):
        ...
        cState=(adjoining_wall_x, adjoining_wall_y, food_dir_x, food_dir_y, adjoining_body_top, adjoining_body_bottom, adjoining_body_left, adjoining_body_right, food_diagonal)
